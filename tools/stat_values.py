...
STATS = [
    ...
    ('dmgns',  r'(?:наносимый )?урон не от статусов',
    ...
    ('takeas', r'получаемый урон от атак и умений','受到的攻擊與技能傷害', 'Attack & ability damage taken', 'Получаемый урон от атак и умений', 1),
