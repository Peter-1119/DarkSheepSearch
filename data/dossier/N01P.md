...
物件欄位（原型 `ANcl`）：`Ncl1 = 0.5`, `Ncl2 = 1`, `Ncl3 = 1`, `Ncl4 = 0.5`, `Ncl5 = 0`, `Ncl6 = channel`, `acdn = 15.0`, `alev = 5`, `amcs = [50, 55, 60, 65, 70]`, `aran = 110.0`, `atar = air,ground,debris,enemy,neutral,organic`
...
物件欄位（原型 `Absk`）：`abuf = B00R`, `acdn = [11.0, 12.0, 13.0, 14.0, 10.0]`, `adur = [5.0, 6.0, 7.0, 8.0, 9.0]`, `ahdu = [5.0, 6.0, 7.0, 8.0, 9.0]`, `aher = 1`, `alev = 5`, `amcs = [45, 50, 55, 60, 65]`, `bsk1 = 0.0`, `bsk2 = 0.0`, `bsk3 = 0.0`
