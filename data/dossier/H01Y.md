...
物件欄位（原型 `ANcl`）：`Ncl1 = 1.0`, `Ncl2 = 2`, `Ncl3 = 3`, `Ncl4 = 1.0`, `Ncl5 = 0`, `Ncl6 = channel`, `aare = 250.0`, `acdn = 16.0`, `alev = 5`, `amcs = [100, 120, 140, 160, 180]`, `aran = 800.0`, `atar = air,ground,debris,enemy,neutral,organic`
...
物件欄位（原型 `Absk`）：`abuf = ['', 'B00G']`, `acdn = [150.0, 25.0]`, `adur = [0.10000000149011612, 10.0]`, `ahdu = [0.10000000149011612, 10.0]`, `aher = 1`, `amcs = [500, 80, 90, 100, 110]`, `bsk1 = [0.0, 0.42000001668930054, 0.48000001907348633, 0.5400000214576721, 0.6000000238418579]`, `bsk2 = 0.0`, `bsk3 = 0.0`
...
物件欄位（原型 `ANcl`）：`Ncl1 = [1.600000023841858, 0.8999999761581421]`, `Ncl2 = [1, 2]`, `Ncl3 = [3, 1]`, `Ncl4 = [1.600000023841858, 0.8999999761581421]`, `Ncl5 = 0`, `Ncl6 = ['channel', 'charm']`, `aare = 210.0`, `acap = `, `acdn = [20.0, 16.0]`, `aher = 0`, `alev = 1`, `amcs = [75, 95, 110, 125, 140, 155, 170]`, `aran = [800.0, 100.0]`, `atar = air,ground,debris,enemy,neutral,organic`
...
物件欄位（原型 `ANcl`）：`Ncl1 = [1.2000000476837158, 0.8999999761581421]`, `Ncl2 = 1`, `Ncl3 = 1`, `Ncl4 = [1.2000000476837158, 0.8999999761581421]`, `Ncl5 = 0`, `Ncl6 = ['channel', 'chemicalrage']`, `acdn = [35.0, 16.0]`, `aher = 0`, `alev = 1`, `amcs = [90, 95, 110, 125, 140, 155, 170]`, `aran = [800.0, 100.0]`, `atar = ['hero,friend,notself,allies', 'air,ground,debris,enemy,neutral,organic']`
...
物件欄位（原型 `ANcl`）：`Ncl1 = [1.2000000476837158, 0.8999999761581421]`, `Ncl2 = [1, 2]`, `Ncl3 = 1`, `Ncl4 = [1.2000000476837158, 0.8999999761581421]`, `Ncl5 = 0`, `Ncl6 = ['channel', 'etherealform']`, `acdn = [1.0, 16.0]`, `aher = 0`, `alev = 1`, `amcs = [95, 110, 125, 140, 155, 170]`, `aran = [1000.0, 100.0]`, `atar = ['hero,notself,allies', 'air,ground,debris,enemy,neutral,organic']`
