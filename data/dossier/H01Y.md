...
`HeroQ51_EndDebuff`　war3map.j:62624
```jass
function HeroQ51_EndDebuff takes nothing returns nothing
local timer t=GetExpiredTimer()
local integer Id=GetHandleId(t)
...
`Trig_HeroW51_Actions`　war3map.j:62845
```jass
...
`Trig_HeroW51_Stop_Actions`　war3map.j:62886
```jass
function Trig_HeroW51_Stop_Actions takes nothing returns nothing
local unit u=GetSpellAbilityUnit()
local integer Id=GetHandleId(u)
...
`Trig_HeroE51_Actions`　war3map.j:62911
```jass
function Trig_HeroE51_Actions takes nothing returns nothing
local unit u=GetSpellAbilityUnit()
local unit u2
...
`Trig_HeroR51_Actions`　war3map.j:63052
```jass
...
`Trig_HeroD51_var1_Actions`　war3map.j:63156
```jass
...
`HeroD51_var2_EndBuff`　war3map.j:63228
```jass
...
`Trig_HeroD51_var2_Actions`　war3map.j:63253
```jass
...
`HeroD51_var3_Wave`　war3map.j:63300
```jass
...
`Trig_HeroD51_var3_Actions`　war3map.j:63386
```jass
