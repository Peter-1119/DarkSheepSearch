...
`Trig_HeroSkills3_Actions`　war3map.j:47204
```jass
...
`Trig_HeroAttack3_Actions`　war3map.j:47273
```jass
...
`HeroW3_conditions`　war3map.j:47309
```jass
...
`Trig_HeroW3_Stop_Conditions`　war3map.j:47392
```jass
...
`Trig_HeroSkills3_Actions`　war3map.j:47192
```jass
if Skill=='A00Y' then
...
`Trig_HeroSkills3_Actions`　war3map.j:47211
```jass
...
`Trig_HeroSkills3_Actions`　war3map.j:47159
```jass
if Skill=='A06M' then
...
`Trig_HeroSkills3_Actions`　war3map.j:47177
```jass
elseif Skill=='A0R0' then
call SetHeroStr(u,GetHeroStr(u,false)+2,true)
call SetHeroAgi(u,GetHeroAgi(u,false)+3,true)
...
`Trig_CreateHero3_Actions`　war3map.j:36010
```jass
...
`Trig_CreateHero3_Hard_Actions`　war3map.j:36337
```jass
...
`HeroSkills3_Conditions`　war3map.j:47079
```jass
...
`Trig_HeroAttack3_Conditions`　war3map.j:47257
```jass
...
`Trig_HeroW3_Actions`　war3map.j:47367
```jass
function Trig_HeroW3_Actions takes nothing returns nothing
local unit u=GetSpellAbilityUnit()
local player pl=GetOwningPlayer(u)
...
`Trig_HeroW3_Stop_Actions`　war3map.j:47395
```jass
function Trig_HeroW3_Stop_Actions takes nothing returns nothing
local unit u=GetSpellAbilityUnit()
local integer Id=GetHandleId(u)
