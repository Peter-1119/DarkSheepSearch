...
`StartCooldown`　war3map.j:2928
```jass
function StartCooldown takes integer Key_1,integer Key_2,real time returns nothing
local timer t=CreateTimer()
local integer Id=GetHandleId(t)
call SaveInteger(hash,Key_1,Key_2,1)
call SaveInteger(hash,Id,1,Key_1)
call SaveInteger(hash,Id,2,Key_2)
call TimerStart(t,time,false,function EndCooldown)
set t=null
endfunction
```
