...
物件欄位（原型 `Absk`）：`abuf = B025`, `acdn = 26.0`, `adur = 12.0`, `ahdu = 12.0`, `aher = 1`, `alev = 5`, `amcs = [100, 115, 130, 145, 160]`, `bsk1 = [0.15000000596046448, 0.20000000298023224, 0.25, 0.30000001192092896, 0.10000000149011612]`, `bsk2 = [0.20000000298023224, 0.30000001192092896, 0.4000000059604645, 0.5, 0.6000000238418579]`, `bsk3 = 0.0`
