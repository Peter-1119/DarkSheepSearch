...
物件欄位（原型 `ANcl`）：`Ncl1 = 0.5`, `Ncl2 = 1`, `Ncl3 = 1`, `Ncl4 = 0.5`, `Ncl5 = 0`, `Ncl6 = channel`, `acap = `, `acdn = 9.0`, `alev = 5`, `amcs = [80, 90, 100, 110, 120]`, `aran = 135.0`, `atar = air,enemies,ground,neutral,organic,item,debris`
...
物件欄位（原型 `ANcl`）：`Ncl1 = [0.5, 0.8999999761581421]`, `Ncl2 = 1`, `Ncl3 = 1`, `Ncl4 = [0.5, 0.8999999761581421]`, `Ncl5 = 0`, `Ncl6 = ['channel', 'disenchant']`, `acap = `, `acdn = [5.0, 16.0]`, `aher = 0`, `alev = 1`, `amcs = [95, 110, 125, 140, 155, 170, 25]`, `aran = [100.0, 135.0]`, `atar = ['air,enemies,ground,neutral,organic,item,debris', 'air,ground,debris,enemy,neutral,organic']`
