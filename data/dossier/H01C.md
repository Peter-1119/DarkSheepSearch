...
物件欄位（原型 `Assk`）：`Ssk1 = 100.0`, `Ssk2 = 0.10000000149011612`, `Ssk3 = [18.0, 24.0, 30.0, 36.0]`, `Ssk4 = 1`, `Ssk5 = 0`, `aher = 1`, `alev = 5`, `atar = enemy,ally`
...
物件欄位（原型 `ANcl`）：`Ncl1 = 1.0`, `Ncl2 = 2`, `Ncl3 = 3`, `Ncl4 = 1.0`, `Ncl5 = 0`, `Ncl6 = channel`, `aare = 500.0`, `acap = `, `acdn = 40.0`, `alev = 5`, `amcs = [80, 95, 110, 125, 140]`, `aran = 1000.0`, `atar = air,ground,debris,enemy,neutral,organic`
...
物件欄位（原型 `ANcl`）：`Ncl1 = [0.009999999776482582, 1.0]`, `Ncl2 = [1, 2]`, `Ncl3 = [3, 1]`, `Ncl4 = [0.009999999776482582, 1.0]`, `Ncl5 = 0`, `Ncl6 = ['channel', 'charm']`, `aare = 400.0`, `acdn = [80.0, 17.0]`, `alev = 1`, `amcs = [200, 80, 90, 100, 110, 120]`, `aran = [700.0, 2000.0]`, `atar = air,ground,friend,neutral,self`
