...
`Trig_HeroSkills19_Actions`　war3map.j:52805
```jass
...
`Trig_HeroSkills19_Actions`　war3map.j:52798
```jass
if Skill=='A05T' then
set x=GetSpellTargetX()
set y=GetSpellTargetY()
...
`Trig_HeroSkills19_Actions`　war3map.j:52812
```jass
...
`Trig_HeroSkills19_Actions`　war3map.j:52780
```jass
if Skill=='A0PW' then
...
`Trig_HeroSkills19_Actions`　war3map.j:52788
```jass
elseif Skill=='A0QY' then
call SetHeroStr(u,GetHeroStr(u,false)+4,true)
call SetHeroAgi(u,GetHeroAgi(u,false)+2,true)
...
`Trig_HeroLvlUp_Actions`　war3map.j:45572
```jass
