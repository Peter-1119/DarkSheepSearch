...
`Trig_HeroSkills15_Actions`　war3map.j:51175
```jass
...
`Trig_HeroKills15_Actions`　war3map.j:51245
```jass
...
`Trig_HeroSkills15_Actions`　war3map.j:51152
```jass
...
`Trig_UseItem_Actions`　war3map.j:27435
```jass
...
`Trig_HeroSkills15_Actions`　war3map.j:51137
```jass
if Skill=='A0ML' then
call SetHeroStr(u,GetHeroStr(u,false)+3,true)
...
`Trig_HeroSkills15_Actions`　war3map.j:51143
```jass
elseif Skill=='A0MN' then
call SetHeroStr(u,GetHeroStr(u,false)+5,true)
call SetHeroAgi(u,GetHeroAgi(u,false)+1,true)
...
`Trig_HeroTakeDamage_Actions`　war3map.j:19843
```jass
...
`Trig_HeroKills15_Conditions`　war3map.j:51192
```jass
...
`Trig_HeroItems15_Actions`　war3map.j:51293
```jass
