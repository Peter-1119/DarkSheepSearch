...
`Trig_Ice_Blades_Conditions`　war3map.j:55864
```jass
...
`Trig_Ice_Blades_Move1`　war3map.j:55940
```jass
else
set gg2=CreateGroup()
...
`Trig_Ice_Blades_Actions`　war3map.j:55994
```jass
...
`Trig_HeroSkills30_Actions`　war3map.j:55784
```jass
...
`Trig_HeroSkills30_Actions`　war3map.j:55838
```jass
...
`Trig_HeroSkills30_Actions`　war3map.j:55827
```jass
...
`Trig_HeroSkills30_Actions`　war3map.j:55767
```jass
if Skill=='A102' then
...
`Trig_HeroSkills30_Actions`　war3map.j:55774
```jass
elseif Skill=='A104' then
call SetHeroStr(u,GetHeroStr(u,false)+5,true)
call SetHeroAgi(u,GetHeroAgi(u,false)+2,true)
...
`Trig_HeroKills30_Conditions`　war3map.j:56022
```jass
...
`Trig_HeroKills30_Actions`　war3map.j:56025
```jass
