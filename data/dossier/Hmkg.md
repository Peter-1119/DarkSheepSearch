...
物件欄位（原型 `ANcl`）：`Ncl1 = 0.20000000298023224`, `Ncl2 = 2`, `Ncl3 = 1`, `Ncl4 = 0.20000000298023224`, `Ncl5 = 0`, `Ncl6 = channel`, `acdn = 10.0`, `alev = 5`, `amcs = [75, 84, 93, 102, 111]`, `aran = 700.0`, `atar = air,enemies,ground,neutral,organic,item,debris`
...
物件欄位（原型 `ANcl`）：`Ncl1 = [0.5, 1.0]`, `Ncl3 = 1`, `Ncl4 = [0.5, 1.0]`, `Ncl5 = 0`, `Ncl6 = ['channel', 'spies']`, `acdn = [100.0, 30.0]`, `alev = 1`, `amcs = [185, 70, 80, 90, 100, 110]`, `aran = 800.0`, `atar = air,ground,debris,enemy,neutral,organic`
