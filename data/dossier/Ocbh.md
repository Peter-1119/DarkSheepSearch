...
主屬性 **力量** · 背包 **6 格** · 解鎖 4000000 · 定位 戰士/坦克/法師 · **近戰**
...
**縮放**：吃技能強度的技能 ['A01D'] ／ ◈ 吃裝備技能威力 無 ／ ⊕ 給裝備技能威力 無
...
- **假單位中繼** —— 技能建一隻空殼單位、把傷害存進它的 **key 13**，`Trig_HeroTakeDamage_Actions` 開頭會把攻擊者換回英雄再打一次 —— 所以**傷害算英雄打的**：吃 DefCof、帶穿透、擊殺也算英雄的。**這跟召喚物完全相反，不要混為一談。**另外中繼重打的是存進去的固定值，所以引擎的濺射衰減會被繞過。
