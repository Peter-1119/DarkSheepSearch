...
`Trig_HeroSkills31_Actions`　war3map.j:56239
```jass
if Skill=='A0EX' then
set x=GetUnitX(u)
set y=GetUnitY(u)
...
`Trig_HeroSkills31_Actions`　war3map.j:56264
```jass
...
`Trig_ice_attack_Conditions`　war3map.j:56283
```jass
...
`Trig_ice_attack_Actions`　war3map.j:56422
```jass
...
`Trig_HeroSkills31_Actions`　war3map.j:56222
```jass
if Skill=='A108' then
...
`Trig_HeroSkills31_Actions`　war3map.j:56259
```jass
...
`Trig_HeroSkills31_Actions`　war3map.j:56229
```jass
elseif Skill=='A10A' then
call SetHeroStr(u,GetHeroStr(u,false)+6,true)
call SetHeroAgi(u,GetHeroAgi(u,false)+3,true)
