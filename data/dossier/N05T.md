...
`Trig_HeroSkills40_Actions`　war3map.j:58941
```jass
...
`Trig_HeroKills40_Actions`　war3map.j:58979
```jass
...
`Trig_HeroSkills40_Actions`　war3map.j:58933
```jass
if Skill=='A0T2' then
...
`Trig_HeroAttack40_Actions`　war3map.j:59069
```jass
...
`Trig_HeroAttack40_Alt_Actions`　war3map.j:59108
```jass
...
`Trig_HeroKills40_Conditions`　war3map.j:58964
```jass
...
`Trig_HeroAttack40_Conditions`　war3map.j:59030
```jass
...
`Trig_HeroAttack40_Alt_Conditions`　war3map.j:59105
```jass
