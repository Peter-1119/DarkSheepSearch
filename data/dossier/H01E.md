...
`Trig_HeroSkills14_Actions`　war3map.j:51071
```jass
...
`Trig_HeroSkills14_Actions`　war3map.j:51034
```jass
...
`Trig_HeroSkills14_Actions`　war3map.j:50983
```jass
if Skill=='A067' then
...
`Trig_HeroSkills14_Actions`　war3map.j:51017
```jass
...
`Trig_HeroSkills14_Actions`　war3map.j:50966
```jass
if Skill=='A0JK' then
...
`Trig_HeroSkills14_Actions`　war3map.j:50974
```jass
elseif Skill=='A0LX' then
call SetHeroStr(u,GetHeroStr(u,false)+2,true)
call SetHeroAgi(u,GetHeroAgi(u,false)+1,true)
...
`Trig_CreateHero14_Actions`　war3map.j:36957
```jass
