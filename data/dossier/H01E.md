...
```
Ежесекундно восстаналивает здоровье ближайших союзников на 1%. Эффект глобальный.
```

物件欄位（原型 `ACua`）：`Uau1 = 0.0`, `Uau2 = 0.009999999776482582`, `Uau3 = 1`, `aare = 99999.0`, `abuf = B00I`
