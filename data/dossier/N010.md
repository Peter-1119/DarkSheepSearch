...
物件欄位（原型 `Absk`）：`abuf = B007`, `acdn = 28.0`, `adur = 15.0`, `ahdu = 15.0`, `aher = 1`, `alev = 5`, `amcs = [60, 67, 74, 81, 88]`, `bsk1 = [0.25, 0.30000001192092896, 0.3500000238418579, 0.40000003576278687]`, `bsk2 = [0.30000001192092896, 0.4000000059604645, 0.5, 0.6000000238418579, 0.7000000476837158]`, `bsk3 = 0.0`
...
物件欄位（原型 `ANcl`）：`Ncl1 = 0.009999999776482582`, `Ncl2 = 1`, `Ncl3 = 1`, `Ncl4 = 0.009999999776482582`, `Ncl5 = 0`, `Ncl6 = channel`, `acdn = 18.0`, `alev = 5`, `amcs = [85, 95, 105, 115, 125]`, `aran = 100.0`, `atar = air,ground,debris,enemy,neutral,organic`
