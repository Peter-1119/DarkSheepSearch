...
主屬性 **敏捷** · 背包 **6 格** · 解鎖 50000 · 定位 斂財/詛咒者/刺客 · **遠程**（攻擊距離 500） · 護甲類型 **small**
...
物件欄位（原型 `ANcl`）：`Ncl1 = [0.10000000149011612, None]`, `Ncl3 = 1`, `Ncl4 = [0.10000000149011612, None]`, `Ncl5 = [0, None]`, `Ncl6 = [None, 'channel']`, `acap = `, `acdn = 120.0`, `alev = 1`

實作：

`Trig_HeroSkills29_Actions`　war3map.j:55522
```jass
...
`Trig_HeroCheckSkills29_Actions`　war3map.j:55590
```jass
...
`Trig_HeroSkills29_Actions`　war3map.j:55500
```jass
if Skill=='A0DV' then
...
物件欄位（原型 `ANab`）：`Nab3 = [None, 6, 7]`, `Nab4 = [12.0, 18.0, 24.0, 30.0, 36.0]`, `Nab5 = [8.0, 12.0, 16.0, 20.0, 24.0]`, `aare = 250.0`, `acdn = 15.0`, `ahdu = 7.0`, `alev = 5`, `amac = 0.30000001192092896`, `amcs = [65, None, 85, 95, 105]`, `amsp = 900`
...
物件欄位（原型 `Assk`）：`Ssk1 = 60.0`, `Ssk2 = 2.0`, `Ssk3 = [14.0, 21.0, 28.0, 35.0, 42.0]`, `Ssk4 = [None, 1]`, `Ssk5 = [None, 1]`, `aher = 1`, `alev = 5`, `atar = [None, 'enemy,ally']`
...
`Trig_HeroSkills29_Actions`　war3map.j:55559
```jass
...
`Trig_HeroCheckSkills29_Actions`　war3map.j:55592
```jass
