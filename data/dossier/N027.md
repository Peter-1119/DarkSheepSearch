...
`Trig_HeroAttack22_Actions`　war3map.j:53581
```jass
...
`Trig_HeroSkills22_Actions`　war3map.j:53466
```jass
...
`Trig_HeroSkills22_Actions`　war3map.j:53474
```jass
...
`Trig_HeroAttack22_Actions`　war3map.j:53551
```jass
...
`Trig_HeroSkills22_Actions`　war3map.j:53460
```jass
if Skill=='A099' then
...
`Trig_HeroSkillCheck22_Conditions`　war3map.j:53511
```jass
...
`Trig_HeroSkills22_Actions`　war3map.j:53441
```jass
if Skill=='A0YK' then
...
`Trig_HeroSkills22_Actions`　war3map.j:53451
```jass
elseif Skill=='A0YM' then
call SetHeroStr(u,GetHeroStr(u,false)+4,true)
call SetHeroAgi(u,GetHeroAgi(u,false)+2,true)
...
`Trig_CreateHero22_Actions`　war3map.j:43744
```jass
...
`Trig_CreateHero22_extra_Actions`　war3map.j:43814
```jass
...
`Trig_HeroSkillCheck22_Actions`　war3map.j:53514
```jass
function Trig_HeroSkillCheck22_Actions takes nothing returns nothing
local unit u=GetSpellAbilityUnit()
local unit u2=GetSpellTargetUnit()
