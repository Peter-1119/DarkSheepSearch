...
物件欄位（原型 `AOw2`）：`Wrs1 = 0.10000000149011612`, `aare = 300.0`, `acdn = 9.0`, `adur = 5.0`, `ahdu = 2.0`, `alev = 5`, `amcs = [80, 100, 110, 120]`
...
物件欄位（原型 `ANcl`）：`Ncl1 = [1.0, 0.8999999761581421]`, `Ncl2 = 1`, `Ncl3 = 1`, `Ncl4 = [1.0, 0.8999999761581421]`, `Ncl5 = 0`, `Ncl6 = ['channel', 'dreadlordinferno']`, `aare = 200.0`, `acdn = [90.0, 16.0]`, `aher = 0`, `alev = 1`, `amcs = [95, 110, 125, 140, 155, 170]`, `aran = [200.0, 100.0]`, `atar = ['player,structure', 'air,ground,debris,enemy,neutral,organic']`
