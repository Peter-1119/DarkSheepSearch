...
物件欄位（原型 `ANcl`）：`Ncl1 = 0.5`, `Ncl2 = 1`, `Ncl3 = 1`, `Ncl4 = 0.5`, `Ncl5 = 0`, `Ncl6 = channel`, `acdn = 12.0`, `alev = 5`, `amcs = [80, 90, 105, 125, 150]`, `aran = 375.0`, `atar = air,enemies,ground,neutral,organic,item,debris`
...
物件欄位（原型 `ANcl`）：`Ncl1 = [0.5, 0.8999999761581421]`, `Ncl2 = 1`, `Ncl3 = 1`, `Ncl4 = [0.5, 0.8999999761581421]`, `Ncl5 = 0`, `Ncl6 = ['channel', 'acidbomb']`, `acap = `, `acdn = [1.0, 16.0]`, `aher = 0`, `alev = 1`, `amcs = [95, 110, 125, 140, 155, 170]`, `aran = 100.0`, `arqa = 21`, `atar = air,ground,debris,enemy,neutral,organic`
...
物件欄位（原型 `ANcl`）：`Ncl1 = [0.5, 0.8999999761581421]`, `Ncl2 = 1`, `Ncl3 = 1`, `Ncl4 = [0.5, 0.8999999761581421]`, `Ncl5 = 0`, `Ncl6 = ['channel', 'acolyteharvest']`, `acap = `, `acdn = [1.0, 16.0]`, `aher = 0`, `alev = 1`, `amcs = [95, 110, 125, 140, 155, 170]`, `aran = 100.0`, `arqa = 23`, `atar = air,ground,debris,enemy,neutral,organic`
...
物件欄位（原型 `ANcl`）：`Ncl1 = [0.5, 1.0]`, `Ncl3 = 1`, `Ncl4 = [0.5, 1.0]`, `Ncl5 = 0`, `Ncl6 = ['channel', 'spies']`, `acdn = [90.0, 30.0]`, `alev = 1`, `amcs = [135, 70, 80, 90, 100, 110]`, `aran = 800.0`, `atar = air,ground,debris,enemy,neutral,organic`
