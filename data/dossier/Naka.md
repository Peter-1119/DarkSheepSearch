...
主屬性 **智力** · 背包 **6 格** · 解鎖 500000 · 定位 法師/輔助 · **遠程**（攻擊距離 600）
...
物件欄位（原型 `ANcl`）：`Ncl1 = 1.0`, `Ncl2 = 2`, `Ncl3 = 1`, `Ncl4 = 1.0`, `Ncl5 = 0`, `Ncl6 = [None, 'channel']`, `acdn = 13.0`, `alev = 5`, `amcs = [90, 105, 120, 135, 150]`, `aran = 700.0`, `atar = air,ground,debris,enemy,neutral,organic`
...
local real y=GetUnitY(u2)
local player pl=GetOwningPlayer(u)
local real dmg=(20.+I2R(GetHeroInt(u,true))*0.20)*0.50
local integer count=LoadInteger(hash,Id,1)
local group ug
set count=count-1
set ug=CreateGroup()
call GroupEnumUnitsInRange(ug,x,y,140,null)
loop
set u3=FirstOfGroup(ug)
exitwhen u3==null
if UnitAlive(u3)and IsUnitEnemy(u3,pl)then
